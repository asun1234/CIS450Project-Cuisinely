...
import {TopTenRecipes, HighProtein, LowSugar, LowCarb, LowFat, LowCal, TopHistory}
    from "./RecipePages";
...
import RecipeCart from "./RecipeCart.js";
// import TopHistory from "./TopHistory.js";


import {Navbar,Nav, NavDropdown} from 'react-bootstrap';
import recipeRow from "./Scrap/RecipeRows";
...
class App extends React.Component{
  ...
  <Navbar.Collapse id="responsive-navbar-nav">
      ...
      <HashRouter>
          ...
            <Route exact path="/topten" component={TopTenRecipes}/>
            ...
            <Route exact path="/recipeCart" component={RecipeCart}/>

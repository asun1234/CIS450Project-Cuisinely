...
class RecipeCart extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            recipesList: [],
    ...
    deleteItem(e) {
        ...
        localStorage.setItem('recipeCart', JSON.stringify(this.state.justRecipes));
    ...
    componentDidMount() {
        ...
        if (localStorage.getItem("recipeCart") !== null) {
            var parsedArr = JSON.parse(localStorage.getItem("recipeCart"));
